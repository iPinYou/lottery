...
THREE.TrackballControls = function ( object, domElement ) {
	...
	// for reset
  _zoomStart.y=0.1295535401018178;
  ...
  // this._zoomStart0=_zoomStart.y;
  this.start=function(){
    _this.count=0;
    _this.x=-0.5;
    _this.beginInterval=setInterval(
      function(){
        //touchstart
        if (_this.count % 587 == 0) {
          _this.count = 0;
          _this.x = -0.5;
          _rotateEnd.copy(_this.getMouseProjectionOnBall(0, 0, _rotateStart));
        }
        //touchend
        else if (_this.count % 587 == 586) {
          _this.x +=0.002;
          _rotateStart.copy(_this.getMouseProjectionOnBall(0, 0, _rotateEnd));
         // _this.reset();
        }
        //touchmove
        else{
          _this.x +=0.002;
          _this.getMouseProjectionOnBall( 0, 0, _rotateEnd );
        }
        _this.count++;
      },40)
  }
  ...
  this.stop=function(){
    ...
    clearInterval(_this.beginInterval);
    _this.beginInterval=null;
    // _this.x=-1;
    // _this.getMouseProjectionOnBall( 0, 0, _rotateEnd );
    // _this.zoomCamera();
